...
<head>
    ...
    <title>Sign In</title>
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background-color: #191b1f; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }
        .auth-container { background-color: #2b2d32; padding: 30px; border-radius: 8px; width: 100%; max-width: 380px; box-shadow: 0 4px 15px rgba(0,0,0,0.3); box-sizing: border-box; }
        .input-control { width: 100%; padding: 12px; margin-bottom: 15px; background-color: #383b40; border: 1px solid #4a4e54; border-radius: 6px; color: #ffffff; font-size: 15px; box-sizing: border-box; }
